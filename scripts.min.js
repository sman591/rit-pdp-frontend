...
var accordion=function(){for(var t,e=toArray(document.querySelectorAll("dt")),o=toArray(document.querySelectorAll("dd")),n=function(t){o[t].style.height=0,o[t].style.fontSize=0,o[t].style.opacity=0},l=function(t,e){o[t].style.height!==e?(o[t].style.height=e,o[t].style.fontSize="16px",o[t].style.opacity=1,o[t].style.borderWidth=t<o.length-1?"1em 0 1.5em 0":"1em 0 0 0"):n(t)},i=0;i<e.length;i++)t=o[i].offsetHeight+"px",console.log(t),function(t,e,o){t[e].addEventListener("click",function(){l(e,o)},!1)}(e,i,t),n(i)};

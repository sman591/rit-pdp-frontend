...
function getQueryVariable(a){for(var t=window.location.search.substring(1),o=t.split("&"),e=0;e<o.length;e++){var n=o[e].split("=");if(n[0]==a)return n[1]}}var rootLoc="http://dgonyeontid.csh.rit.edu",hasClass=function(a,t){return new RegExp(" "+t+" ").test(" "+a.className+" ")},removeClass=function(a,t){var o=new RegExp("(?:^|\\s)"+t+"(?!\\S)");a.className=a.className.replace(o,"")},toArray=function(a){return Array.prototype.slice.call(a)};window.onload=function(){document.querySelector("body").className="";var a=function(a){return toArray(document.querySelectorAll(a))},t=function(a){return window.location.href.indexOf(a)>-1};t("resources")&&subPageNavigation(a("nav.two > a")),t("committee")&&(subPageNavigation(a("nav.two > a")),committeePageNavigation()),t("contact")&&contactValidation(),t("forms")&&subPageNavigation(a("nav.custom2 a")),t("faq")&&accordion()};
...
function getQueryVariable(a){for(var t=window.location.search.substring(1),n=t.split("&"),e=0;e<n.length;e++){var o=n[e].split("=");if(o[0]==a)return o[1]}}function getMonthNum(a){var t={};return t.jan="01",t.feb="02",t.mar="03",t.apr="04",t.may="05",t.jun="06",t.jul="07",t.aug="08",t.sep="09",t.oct="10",t.nov="11",t.dec="12",t[a]}function translateDate(a){var t=a.split(" "),n=getMonthNum(t[1]),a=n+"/";return a+=t[2]+"/",a+=t[3]+" 12:00 PM"}var rootLoc="http://129.21.49.72",hasClass=function(a,t){return new RegExp(" "+t+" ").test(" "+a.className+" ")},removeClass=function(a,t){var n=new RegExp("(?:^|\\s)"+t+"(?!\\S)");a.className=a.className.replace(n,"")},toArray=function(a){return Array.prototype.slice.call(a)};window.onload=function(){document.querySelector("body").className="";var a=function(a){return toArray(document.querySelectorAll(a))},t=function(a){return window.location.href.indexOf(a)>-1};t("resources")&&subPageNavigation(a("nav.two > a")),t("committee")&&(subPageNavigation(a("nav.two > a")),committeePageNavigation()),t("contact")&&contactValidation(),t("forms")&&subPageNavigation(a("nav.custom2 a")),t("faq")&&accordion()};
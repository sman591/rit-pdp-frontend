...
function getQueryVariable(t){for(var a=window.location.search.substring(1),e=a.split("&"),o=0;o<e.length;o++){var n=e[o].split("=");if(n[0]==t)return n[1]}}function formatDate(t){return console.log("FormatDate: "+t),void 0!==t&&null!==t?(result=moment(t).format("MM/DD/YYYY hh:mm a"),console.log(result),result):""}function getMonthNum(t){var a={};return a.jan="01",a.feb="02",a.mar="03",a.apr="04",a.may="05",a.jun="06",a.jul="07",a.aug="08",a.sep="09",a.oct="10",a.nov="11",a.dec="12",a[t]}function translateDate(t){var a=t.split(" "),e=getMonthNum(a[1]),t=e+"/";return t+=a[2]+"/",t+=a[3]+" 12:00 PM"}var rootLoc="http://athena.csh.rit.edu:",hasClass=function(t,a){return new RegExp(" "+a+" ").test(" "+t.className+" ")},removeClass=function(t,a){var e=new RegExp("(?:^|\\s)"+a+"(?!\\S)");t.className=t.className.replace(e,"")},toArray=function(t){return Array.prototype.slice.call(t)};window.onload=function(){document.querySelector("body").className="";var t=function(t){return toArray(document.querySelectorAll(t))},a=function(t){return window.location.href.indexOf(t)>-1};a("resources")&&subPageNavigation(t("nav.two > a")),a("committee")&&(subPageNavigation(t("nav.two > a")),committeePageNavigation()),a("contact")&&contactValidation(),a("forms")&&subPageNavigation(t("nav.custom2 a")),a("faq")&&accordion()};